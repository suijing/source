...
namespace com.itianchuang.DAL
{
	...
	public partial class user_type
	{
		...
		public int GetMaxId()
		{
		return MySqlHelper.GetMaxID("id", "user_type"); 
		}
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from user_type");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into user_type(");
			strSql.Append("type_name,remark,is_value)");
			strSql.Append(" values (");
			strSql.Append("@type_name,@remark,@is_value)");
			MySqlParameter[] parameters = {
					new MySqlParameter("@type_name", MySqlDbType.VarChar,20),
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update user_type set ");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from user_type ");
			strSql.Append(" where id=@id");
			MySqlParameter[] parameters = {
					new MySqlParameter("@id", MySqlDbType.Int32)
			};
		...
		public com.itianchuang.Model.user_type GetModel(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,type_name,remark,is_value from user_type ");
			strSql.Append(" where id=@id");
			MySqlParameter[] parameters = {
					new MySqlParameter("@id", MySqlDbType.Int32)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public com.itianchuang.Model.user_type DataRowToModel(DataRow row)
		{
			com.itianchuang.Model.user_type model=new com.itianchuang.Model.user_type();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,type_name,remark,is_value ");
			strSql.Append(" FROM user_type ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from user_type T ");
