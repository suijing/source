...
namespace com.itianchuang.DAL
{
	...
	public partial class device
	{
		...
		public int GetMaxId()
		{
		return MySqlHelper.GetMaxID("id", "device"); 
		}
		...
		public bool Add(com.itianchuang.Model.device model)
		{
			...
			strSql.Append("device_name,ip,mac,remark,is_value)");
			strSql.Append(" values (");
			strSql.Append("@device_name,@ip,@mac,@remark,@is_value)");
			MySqlParameter[] parameters = {
					new MySqlParameter("@device_name", MySqlDbType.VarChar,32),
					new MySqlParameter("@ip", MySqlDbType.VarChar,15),
					new MySqlParameter("@mac", MySqlDbType.VarChar,16),
			...
			parameters[4].Value = model.is_value;
		...
		public com.itianchuang.Model.device GetModel(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,device_name,ip,mac,remark,is_value from device ");
			strSql.Append(" where id=@id");
			MySqlParameter[] parameters = {
					new MySqlParameter("@id", MySqlDbType.Int32)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public com.itianchuang.Model.device DataRowToModel(DataRow row)
		{
			com.itianchuang.Model.device model=new com.itianchuang.Model.device();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,device_name,ip,mac,remark,is_value ");
